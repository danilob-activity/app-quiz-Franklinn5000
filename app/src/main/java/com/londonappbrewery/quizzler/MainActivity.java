...
//atualiza texto do score
    ...
    public void updateQuestion() {
        ...
        if (mIndex == 0) {
            ...
            alert.setMessage("You scored " + Math.ceil((float)mScore/mQuestionBank.length * 100) + "%");
